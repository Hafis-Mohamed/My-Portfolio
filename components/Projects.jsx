          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="p-7 flex flex-col justify-between flex-grow">
                <div>
                  <h3 className="font-display text-xl font-bold mb-3 flex items-start justify-between gap-2">
                    <span className="text-white group-hover:text-indigo-200 transition-colors">
                      {project.title}
                    </span>
                    <ArrowUpRight className="w-5 h-5 text-slate-600 group-hover:text-indigo-300 shrink-0 mt-1 transition-colors" />
                  </h3>
